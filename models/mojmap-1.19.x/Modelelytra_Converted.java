...
public class Modelelytra_Converted<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart wingsflying;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wingsflying = partdefinition.addOrReplaceChild("wingsflying", CubeListBuilder.create(),
				PartPose.offset(20.0F, 1.0F, 3.0F));

		PartDefinition right_r1 = wingsflying.addOrReplaceChild("right_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(8.0F, 0.0F, -1.0F, 10.0F, 20.0F, 2.0F,
		...
		PartDefinition left_r1 = wingsflying.addOrReplaceChild("left_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -5.0F, -1.0F, 10.0F, 20.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-34.0F, 4.0F, 8.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition Lw = partdefinition.addOrReplaceChild("Lw", CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F,
				-2.0F, 5.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));

		PartDefinition Rw = partdefinition.addOrReplaceChild("Rw", CubeListBuilder.create().texOffs(0, 0).addBox(-19.0F,
				-2.0F, 5.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));
